...
const sendEmailBlock = async (user) => {
    ...
    try {
        ...
        <![endif]-->
                <table class="es-wrapper" width="100%" cellspacing="0" cellpadding="0">
                    ...
                    <td align="center" class="esd-block-text"><p>Hemos bloqueado tu usuario</p><p>para mas informacion comunicate con el administrador.</p></td>
                </tr>
                                                                                    </tbody>
                                                                                </table>
                                                                            </td>
